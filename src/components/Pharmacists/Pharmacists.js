    ...
    return (
        <div className="p-6 bg-gray-100 rounded-lg shadow-md mt-5">
          ...
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-xl font-bold">Pharmacist List</h1>
                      ...
                      <tbody>
                        {currentUsers.map((pharmacist, index) => (
                          <tr key={pharmacist.id} className="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{pharmacist.fullname}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pharmacist.username}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pharmacist.email}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pharmacist.address}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pharmacist.Salary}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  {pharmacist.Contract && (
                    <a
                      href={`http://localhost:5000/uploads/${pharmacist.Contract}`} // Use the correct URL
                      target="_blank"
                    ...
                    >
                      View Contract
                            ...
                            {/* <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pharmacist.DateOfBirth}</td> */}
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pharmacist.age}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{pharmacist.role}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 flex gap-2">
                              {/* View Button with Tooltip */}
                              {/* <div className="relative group">
                                <button
                                  onClick={() => handleView(pharmacist.id)}
