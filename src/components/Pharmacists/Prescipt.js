  ...
  return (
    <div className="p-6 bg-gray-100 rounded-lg shadow-md mt-5">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-xl font-bold">Prescribes Overview</h1>
...
<tbody>
  {currentBills.map((bill, index) => (
    <tr key={bill.id} className="hover:bg-gray-50 transition-colors duration-200">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{bill.diseases}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{bill.drugName}</td>
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[9999]">
    <div className="bg-white rounded-lg w-11/12 md:w-8/12 lg:w-8/12 max-h-[90vh] overflow-y-auto shadow-xl relative">
      {/* Report Header */}
      <div className="border-b border-gray-200 p-6 bg-gray-50 rounded-t-lg">
        <h1 className="text-2xl font-bold text-gray-800 text-center">Patient Medical Report</h1>
        {/* Cancel (X) Button */}
        <button
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Patient Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Patient ID</label>
              <p className="w-full p-2 border border-gray-200 rounded-md bg-gray-50 text-sm">
        ...
        {/* Card 2: Medical Diagnosis */}
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Medical Diagnosis</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Diseases</label>
              <p className="w-full p-2 border border-gray-200 rounded-md bg-gray-50 text-sm">
        ...
        {/* Card 3: Medication Details */}
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Medication Details</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Medication</label>
              <p className="w-full p-2 border border-gray-200 rounded-md bg-gray-50 text-sm">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Quantity Prescribed</label>
              <p className="w-full p-2 border border-gray-200 rounded-md bg-gray-50 text-sm">
        ...
        {/* Card 4: Billing and Status */}
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Billing and Status</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Additional Notes</h2>
          <p className="text-sm text-gray-600">
            <strong>Important Instructions for the Pharmacist:</strong>
            <br />
            1. Please ensure that the prescribed medication is appropriate for the patient's diagnosed diseases.
            <br />
            2. Verify the stock count before dispensing the medication. If the stock is insufficient, update the inventory and notify the relevant department.
            <br />
            3. Double-check the quantity prescribed to avoid any discrepancies.
            <br />
            4. If there are any issues or concerns regarding the medication, contact the prescribing physician immediately.
          </p>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 p-6 bg-gray-50 rounded-b-lg">
        <p className="text-sm text-gray-500 text-center">
          &copy; {new Date().getFullYear()} Medical Management System. All rights reserved.
        </p>
      </div>
    </div>
  </div>
