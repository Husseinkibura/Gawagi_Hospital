    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          toggleModal();
          fetchTechnicians(); // Refresh the Technicians list
        } else {
          const errorData = await response.json();
          toast.error(errorData.message || "Failed to add technician.");
        }
      } catch (error) {
        toast.error("An error occurred while adding the technician.");
