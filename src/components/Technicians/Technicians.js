    ...
    return (
        <div className="p-6 bg-gray-100 rounded-lg shadow-md mt-5">
          ...
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-xl font-bold">Technician List</h1>
                                ...
                                <tbody>
                                  {currentUsers.map((technician, index) => (
                                    <tr key={technician.id} className="hover:bg-gray-50 transition-colors duration-200">
                                      ...
                                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{technician.fullname}</td>
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{technician.username}</td>
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{technician.email}</td>
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{technician.address}</td>
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{technician.Salary}</td>
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {technician.Contract && (
                              <a
                                href={`http://localhost:5000/uploads/${technician.Contract}`} // Use the correct URL
                                target="_blank"
                              ...
                              >
                                View Contract
                                      ...
                                      {/* <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{technician.DateOfBirth}</td> */}
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{technician.age}</td>
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{technician.role}</td>
