  ...
  const [receptionists, setReceptionists] = useState([]); // Initially empty, fetched from backend
    ...
    return (
      ...
      <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
        <h1 className="text-xl font-bold whitespace-nowrap">Receptionist List</h1>
        ...
        <tbody>
          {currentUsers.map((receptionist, index) => (
            <tr key={receptionist.id} className="hover:bg-gray-50 transition-colors duration-200">
              ...
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{receptionist.fullname}</td>
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receptionist.username}</td>
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receptionist.email}</td>
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receptionist.address}</td>
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receptionist.Salary}</td>
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                {receptionist.Contract && (
                  <a
                    href={`http://localhost:5000/uploads/${receptionist.Contract}`}
                    target="_blank"
              ...
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receptionist.age}</td>
              <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receptionist.role}</td>
