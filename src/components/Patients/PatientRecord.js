      ...
      <div className="max-w-6xl mx-auto">
        ...
        {patient && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Prescribed Drugs</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {drugs.map((drug) => (
                  <div key={drug.id} className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-600">Price: {formatCurrency(drug.price)}</p>
            ...
            {/* Diseases Information Card */}
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Diagnosed Diseases</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {diseases.map((disease, index) => (
                  <div key={index} className="p-4 bg-gray-50 rounded-lg">
                    <h4 className="text-sm font-semibold text-gray-500 mb-2">Disease {index + 1}</h4>
                    <p className="text-gray-600">Name: {disease.disease_name}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {bills.map((bill, index) => (
                  <div key={index} className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-600">Total Amount: {formatCurrency(bill.totalTestPrice + bill.totalDrugPrice)}</p>
